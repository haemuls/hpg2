            ...
            const loadUserData = {
                "Modal.useEffect.loadUserData": async ()=>{
                    try {
                        ...
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`https://api.hpground.xyz/api/users/${membershipId}`, {
                            headers: {
                                Authorization: `Bearer ${jwtToken}`
                            }
                        });
...
//# sourceMappingURL=_8a396470._.js.map