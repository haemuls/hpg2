...
const BoardPage = ()=>{
    ...
    const [searchTerm, setSearchTerm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(""); // 검색어 상태 추가
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const fetchPosts = async ()=>{
        setLoading(true);
        setError("");
        try {
            const response = await fetch(`${API_BASE_URL}/api/boards?type=FREE&page=${currentPage}&size=25&sortByNewest=${sortByDateNewest}&search=${encodeURIComponent(searchTerm)}`, {
                headers: {
                    Authorization: `Bearer ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$token$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAccessToken"])()}`,
                    "Content-Type": "application/json"
                }
            });
            if (!response.ok) {
    ...
    const checkLoginStatus = ()=>{
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$token$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAccessToken"])();
        setIsLoggedIn(!!token);
    };
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: Array.from({
                                    length: totalPages
                                        ...
                                        className: `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$board$2f$board$2e$module$2e$css__$5b$app$2d$ssr$5d$__$28$css__module$29$__["default"].pageNumber} ${index === currentPage ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$board$2f$board$2e$module$2e$css__$5b$app$2d$ssr$5d$__$28$css__module$29$__["default"].active : ""}`,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__329b9728._.js.map